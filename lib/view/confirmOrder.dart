...
/* =========================
   PAYMENT DATA CLASS (replaces controller)
========================= */
class PaymentData {
...
class _ConfirmOrderState extends State<ConfirmOrder> {
  ...
  // QrServices qrServices = QrServices(); // Uncomment if needed
  ...
  Widget build(BuildContext context) {
    bool hasAddress = paymentData.selectedAddress.isNotEmpty;
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  paymentData.selectedShop!.image,
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          '${paymentData.selectedShop!.rating}',
                                          style: TextStyle(
                                            fontSize: 14,
                                            color: Colors.grey[600],
                                          ),
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${paymentData.distanceToShop.toStringAsFixed(1)} km',
                                          style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600,
                                            color: Colors.red[700],
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${paymentData.deliveryTime > 0 ? paymentData.deliveryTime : (paymentData.distanceToShop * 5).ceil()} min',
                                          style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.w600,
...
class _LocationPickerState extends State<LocationPicker> {
  ...
  void _fallbackToStraightLine(LatLng origin, LatLng destination) {
    setState(() {
      ...
      routeDistance =
          widget.paymentData.calculateDistance(origin, destination);
  ...
  void _showShopDetails(Shop shop) {
    ...
    if (shop == nearestShop && routeDistance > 0) {
      ...
      distance =
          widget.paymentData.calculateDistance(selectedPoint, shop.location);
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: Container(
                        ...
                        child:
                            Text(shop.image, style: const TextStyle(fontSize: 24)),
                      ),
                      title: Row(
                        children: [
                          Text(shop.name,
